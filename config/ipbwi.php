...
if(!defined('ipbwi_BOARD_PATH')){
	define('ipbwi_BOARD_PATH', DOCROOT . 'forum' . DIRECTORY_SEPARATOR);
}
...
if(!defined('ipbwi_ROOT_PATH')){
	define('ipbwi_ROOT_PATH', MODPATH . 'ipbwi' . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR . 'ipbwi' . DIRECTORY_SEPARATOR);
}
...
if(!defined('ipbwi_WEB_URL')){
	define('ipbwi_WEB_URL', URL::base(TRUE, TRUE));
}
